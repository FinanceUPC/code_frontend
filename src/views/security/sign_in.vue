  ...
  <div class="signIn">
    <div style="width: 100%; margin: 20px 0; position: fixed">
      <div style="justify-content: center; align-items: center; display: flex">
        ...
        <router-link to="/sign-up" style="text-decoration: none; margin: 0 15px;">
          <button class="button_navigation p-button-rounded">Sign Up</button>
        </router-link>
      </div>
    </div>
    <div class="content">
      <div class="titles">
        <h1>Sing In To Business Operation</h1>
      ...
      <div class="form">
        <div class="inform">
          ...
          <Message v-if="correct" severity="success">your credentials are correct</Message>
          <Message v-if="error" severity="error">The email is incorrect</Message>
...
export default {
  ...
  methods:{
    login(){
      ...
      this.authenticationService.logInUser(JSON.stringify(this.form)).then((response) =>{
